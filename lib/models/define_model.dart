class DefineResponseModel {
  ...
  DefineResponseModel(
      {this.check, this.define, this.conclusion, this.disclaimer});

  DefineResponseModel.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'DefineResponseModel{check: $check, define: $define, conclusion: $conclusion, disclaimer: $disclaimer}';
  }
}

class Check {
  List<String>? medicalConditions;
  List<String>? psychologicalBehaviors;
  List<String>? careSuggestions;
...
class Define {
  ...
  factory Define.fromJson(Map<String, dynamic> json) {
    return Define(
      breed: json['breed'],
      age: json['age'],
